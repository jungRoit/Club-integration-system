        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <form class="form " method="post" action="${SITE_URL}/dashboard/events/update" id="event">
                        <div class="form-group">
                            <label>Event Title</label>
                            <input type="text" class="form-control" name="eventTitle" required="required" value="${event.eventTitle}"/>
                        </div>
                        <div class="form-group">
                            <label>Event Venue</label>
                            <input type="text" class="form-control" name="eventVenue" required="required" value="${event.eventVenue}"/>
                        </div>
                        <div class="form-group">
                            <label>Event Date</label>
                            <input type="date" class="form-control" name="date" required="required" value="${event.eventDate}"/>
                        </div>
                        <div class="form-group">
                            <label>Event Co-Ordinator</label>
                            <input type="text" class="form-control" name="eventcoOrdinator" required="required" value="${event.eventcoOrdinator}"/>
                        </div>
                        <div class="form-group">
                            <label>Event Description</label>
                            <input type="text" class="form-control" name="eventDescription" required="required" value="${event.eventDescription}">
                        </div>
                        <div class="form-group">
                            <label>Event status</label>
                            <input type="text" name="eventStatus" class="form-control" required="required" value="${event.eventStatus}"/>
                        </div>
                        <div class="form-group">
                            <label>Event Image</label>
                            <label class="sm text-success">( Please insert the image you want to upload)</label>
                            <input type="text" name="eventImage" class="form-control" required="required" value="${event.eventImage}"/>
                        </div>
