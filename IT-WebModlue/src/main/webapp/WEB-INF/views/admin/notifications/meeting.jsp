...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Thames IT Club | meeting</title>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="event">
                        ...
                        <div>
                        <ul>
                           <li>Meeting Type : ${meeting.meetingType}</li>
                           <li>Date : ${meeting.meetingDate}</li>
                           <li>Venue : ${meeting.meetingVenue}</li>
                        </ul>
                        </div>
                        
                        
                        <h2>Meeting Agenda</h2>
                        <p style="margin-top: 20px">${meeting.meetingAgenda}</p>
                        <h2>Decisions</h2>
                        <p style="margin-top: 20px">${meeting.meetingDecisions}</p>
                        
                        <button class="btn btn-submit bg-blue"id="btn-response" >Respond</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-uppercase text-center" id="dialog-title">Meeting Response</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                     <form method="post" action="${SITE_URL}/dashboard/meetings/response/save">
                    <div class="modal-body">
                       
                            <div class="form-group ">
                                <label for="recipient-name"  class="form-control-label ">Response</label>
                                <select class="form-control" name="response" required="required">
                                    <option>Going</option>
                            ...
                            <div class="form-group ">
                                <label for="recipient-name"  class="form-control-label ">Reason</label>
                                 <small class="form-text text-muted">please give a reason if you are not going</small>
