            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="col-10">
                        ...
                        <form class="form " method="POST" action="${SITE_URL}/dashboard/mail/save" enctype="multipart/form-data">
                            <div class="form-group">
                               
                                <label>Email Template Title</label>
                                <input type="text" class="form-control" name="templateTitle" required="required"/>
                            </div>
