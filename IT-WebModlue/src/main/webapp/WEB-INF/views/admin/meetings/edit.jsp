        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <a href="${SITE_URL}/dashboard/meetings/" class="btn btn-secondary btn-flat pull-right">Back</a> <br>
                    <form class="form " method="post" action="${SITE_URL}/dashboard/meetings/update" id="meeting">
                       <div class="form-group">
                            <label>Meeting Type</label>
                            <select class="form-control" name="meetingType" required="required">
                                <option>${meeting.meetingType}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meetingTitle" required="required" value="${meeting.meetingTitle}"/>
                        </div>
                        <div class="form-group">
                            <label>Meeting Venue</label>
                            <input type="text" class="form-control" name="meetingVenue" required="required" value="${meeting.meetingVenue}"/>
                        </div>
                        <div class="form-group">
                            <label>Meeting Date</label>
                            <label class="sm text-success">( YYYY-MM-DD HH:mm)</label>
                            <input type="text" class="form-control" name="date" required="required" value="${meeting.meetingDate}"/>
                        </div>
                        <div class="form-group">
                            <label>Meeting Agendas</label>
                            <textarea type="text" class="form-control" name="meetingAgenda" required="required" >
                            ${meeting.meetingAgenda}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label>Meeting Decisions</label>
                            <textarea type="text" class="form-control" name="meetingDecisions"  >
                            ${meeting.meetingDecisions}
                            </textarea>
                        </div>
