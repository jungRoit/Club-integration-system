            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="col-10">
                        ...
                        <form class="form " method="POST" action="${SITE_URL}/dashboard/meetings/save" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meetingTitle" required="required"/>
                            </div>
                            <div class="form-group">
                                <label>Meeting Venue</label>
                                <input type="text" class="form-control" name="meetingVenue" required="required"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="meetingAgenda" required="required">
                                </textarea>
                            </div>
                            <div class="form-group">
                                <label>Meeting Decisions</label>
                                <textarea class="form-control" name="meetingDecisions">
                                </textarea>
                            </div>
