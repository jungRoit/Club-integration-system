        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="col-2"></div>
                    <div class="col-10">
                        <a href="${SITE_URL}/dashboard/mail/" class="btn btn-secondary btn-flat pull-right">Back</a> <br>
                        <form class="form " method="POST" action="${SITE_URL}/dashboard/mail/update" id="template">
                            <div class="form-group">
                               
                                <label>Email Template Title</label>
                                <input type="text" class="form-control" name="templateTitle" required="required" value="${template.templateTitle}"/>
                            </div>
                          
                            <div class="form-group">
                                <label>Event Template Body</label>
                                <textarea class="form-control text-area" name="templateBody" required="required">
