        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        ${event.eventTitle} Event Accounts
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <a href="${SITE_URL}/dashboard/events/accounts/exportEventIncome/${event.eventId}"  class="btn bg-yellow btn-export  pull-right">Export</a> 
                            ...
                            <form id="form-income" method="post" action="${SITE_URL}/dashboard/accounts/saveEvent">
                        ...
                        <div class="col-4">
                            ...
                            <a href="${SITE_URL}/dashboard/events/accounts/exportEventExpenses/${event.eventId}"  class="btn bg-yellow btn-export  pull-right">Export</a> 
                            ...
                            <form id="form-expenditure"  method="post" action="${SITE_URL}/dashboard/accounts/saveEvent">
                                <div class="form-group" >
                                    <label >Particular</label>
                                    <input type="text" class="form-control"name="transactionTitle" required="required">
                                </div>
                        ...
                        <div class="col-4 calc">
                            <div>
                                <table class="table table-responsive-lg table-bordered">
                                    <tr>
                                        <th class="bg-green" >Profit/Loss</th>
          ...
          <div class="modal fade" id="email-modal-exp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="${SITE_URL}/dashboard/accounts/event/expenditure/mail">
        ...
        <div class="modal fade" id="email-modal-inc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="${SITE_URL}/dashboard/accounts/event/income/mail">
                    <div class="modal-body">
