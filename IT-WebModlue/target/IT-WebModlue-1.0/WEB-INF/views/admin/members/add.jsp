        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <form class="form " method="post" action="${SITE_URL}/dashboard/members/save">
            ...
            <script>
                function showDialog(id) {
                    $.getJSON("${SITE_URL}/graph/events/" + id, function (res) {
                        ...
                        var img = res.eventImage;
                        $(".event-image").html("<img src='${SITE_URL}/static/"+img + ".jpg' width='600px' height='400px'/>");
